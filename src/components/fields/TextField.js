...
export default function TextField(props) {
  ...
  return (
    <div className="dynamic-label group relative z-0 mt-3 rounded-md border-4 cursor-text border-pursuit-green bg-transparent p-0 transition-all">
      <textarea
        id={`${fieldName}-input`}
        className="form form-textarea peer w-full outline-none focus:outline-none peer disabled:cursor-disabled block rounded-md border-none bg-transparent p-4 text-zinc-800 disabled:opacity-20"
        name={fieldName}
